function ber_vector = fixed_rate_channel_overlayer(params, snr_range, time_step_ms, sim_time_ms, modulation_scheme)
    ...
    modulated_symbols = qpsk_modulator(bit_stream); % Modulate bits
    ...
    for idx = 1:length(snr_range)
        ...
        % BER calculation
        [~, errorRate] = error_rate_calculator(bit_stream, received_bits);
